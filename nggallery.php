...
if (!class_exists('nggLoader')) {
    ...
    class nggLoader {
        ...
        function load_scripts() {
			...
			// Load AJAX navigation script, works with shutter script and custom script with user defined listener
        ...
        function disable_upgrade($option){
			...
			if( isset($option->response[ $this->plugin_name ]) ){
				...
				if ($this->add_PHP5_notice == false){
					add_action( "in_plugin_update_message-$this->plugin_name", function() {
